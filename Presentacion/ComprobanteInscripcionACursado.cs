...
{
    public partial class ComprobanteInscripcionACursado : Form
    {
        ...
        public ComprobanteInscripcionACursado()
        {
            InitializeComponent();
        }

        private void ComprobanteInscripcionACursado_Load(object sender, EventArgs e)
        {
