...
{
    public partial class FrmInscribirAMateria : Form
    {
        public List<Alumno> listaAlumnos= new List<Alumno>();
        public FrmInscribirAMateria()
        {
        ...
        private void FrmInscribirAMateria_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridViewAlumnos_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if ((e.ColumnIndex == dataGridViewAlumnos.Columns["Seleccionar"].Index))
            {
                ...
                FrmListadoMaterias frmlistadoM = new FrmListadoMaterias(this);

                frmlistadoM.ShowDialog();
